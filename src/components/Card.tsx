...
const Card = ({
    ...
    return (
        <div className='mx-22'>
            ...
            <Link
                href={`/workouts/${id}`}
                className="card bg-neutral text-neutral-content grid-cols-3 justify-between max-w-sm shadow-lg border border-white/10 rounded-2xl overflow-hidden hover:scale-[1.02] transition-transform"
            >
